...
from lib.core.nerf_utils import _extract_geometry, extract_fields
...
class VolumeRenderer(nn.Module):
    ...
    def forward(self, rays_o, rays_d, code, density_bitfield, grid_size,
        ...
        if self.training:
            ...
            weights, weights_sum, depth, image = batch_composite_rays_train(sigmas, rgbs, deltas, rays, num_points, T_thresh)
